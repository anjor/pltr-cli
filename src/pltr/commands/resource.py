    ...
    try:
        ...
        if format == "json":
            if output:
                ...
                formatter.format_dict(resource, format="json")
        elif format == "csv":
            if output:
                formatter.save_to_file([resource], output, "csv")
            else:
                formatter.format_list([resource], format="csv")
        else:
    ...
    try:
        ...
        if format == "json":
            if output:
                ...
                formatter.format_list(resources, format="json")
        elif format == "csv":
            if output:
                formatter.save_to_file(resources, output, "csv")
            else:
                formatter.format_list(resources, format="csv")
        else:
    ...
    try:
        ...
        if format == "json":
            ...
            if output:
                ...
                formatter.format_list(metadata_list, format="csv")
        else:
    ...
    try:
        ...
        if format == "json":
            if output:
                ...
                formatter.format_list(markings, format="json")
        elif format == "csv":
            if output:
                formatter.save_to_file(markings, output, "csv")
            else:
                formatter.format_list(markings, format="csv")
        else:
    ...
    try:
        ...
        if format == "json":
            ...
            if output:
                ...
                formatter.format_list(flat_data, format="csv")
        else:
