...
class TestWidgetsCommands:
    ...
    def test_get_release_success(self, runner, mock_service) -> None:
        ...
        mock_service.get_release.return_value = {
            ...
            "widgetSetRid": "ri.ontology-metadata.main.widget-set.abc123",
        }
    ...
    def test_delete_release_cancelled(self, runner, mock_service) -> None:
        """Test delete release cancelled by user."""
        result = runner.invoke(
            app,
            [
                "widgets",
